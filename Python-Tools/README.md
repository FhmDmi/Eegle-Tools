...
It serves as a Python adaptation of the [Eegle](https://github.com/Marco-Congedo/Eegle.jl) package (Julia), leveraging the power of the Python scientific ecosystem (`numpy`, `pandas`, `scikit-learn`, `pyriemann`, `scipy`, etc.) to facilitate BCI classification tasks.
...
This module handles the exploration and selection of datasets without loading the heavy signal data into memory. It allows you to filter the massive FII BCI Corpus based on specific criteria.
